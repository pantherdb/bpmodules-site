...
from src.resolvers.annotation_resolver import get_annotation, get_annotations
from src.models.annotation_model import Annotation,  AnnotationFilterArgs, AnnotationStats, AutocompleteType, Gene, PageArgs, ResultCount
...
class AnnotationQuery:
    ...
    @strawberry.field
    async def autocomplete(self, info:Info, autocomplete_type: AutocompleteType,  keyword:str, filter_args:typing.Optional[AnnotationFilterArgs]=None,) -> typing.List[Gene]:
